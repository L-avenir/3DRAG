...
class SparseTransformerBase(nn.Module):
    ...
    def __init__(self, in_channels: int, model_channels: int, num_blocks: int, num_heads: Optional[int]=None, num_head_channels: Optional[int]=64, mlp_ratio: float=4.0, attn_mode: Literal['full', 'shift_window', 'shift_sequence', 'shift_order', 'swin']='full', window_size: Optional[int]=None, pe_mode: Literal['ape', 'rope']='ape', use_fp16: bool=False, use_checkpoint: bool=False, qk_rms_norm: bool=False):
        super().__init__()
